...
class AttachmentsController extends JController
{
	...
	/** Known views to close from
	 */
	var $_known_froms = array('frontpage', 'article', 'section', 'category', 'editor', 'details', 'closeme');
	...
	function upload()
	{
		...
		// Add the various related view URLs (switch to URL, etc)
		if ( $new_parent ) {
	...
	function save()
	{
		...
		if ( in_array( $from, $this->_known_froms ) ) {
