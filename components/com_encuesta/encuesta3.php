...
-->
		 ...
		 <h3 class="ache_blanco" color="#FFF" >Facultad de Ciencias, Económicas y Sociales FACES-ULA</h3>
		 <!--<div>-->
			<h4 class="ache_blanco" color="#FFF" >Grupo de Investigación Sobre Agricultira Gerencia y Ambiente</h4>
	...
	jQuery(document).ready(function($){
		...
		<div class="">
			...
			<center>
				...
				<form id="form" action="pr0c3s4r3.php" method="post" onsubmit="return validar(this)" >
						...
						<tr>
							<td>
								<p>
									...
									estructura a expertos y planificadores, para identificar los desafios que se impondrán a 
									...
									aplicación:</strong> Septiembre 2012 - Junio 2013 <strong>- Forma de aplicación: </strong>
									...
									<tr>
										<td>
											...
											<br>
												&nbsp;&nbsp; &nbsp; &nbsp;
												&nbsp;&nbsp; &nbsp; &nbsp;
												<input type="checkbox" name="p1a" value="<?php echo $q['p1a']; ?>" />
												<?php echo $q['p1a']; ?>
												
											<br>
												&nbsp;&nbsp; &nbsp; &nbsp;
												&nbsp;&nbsp; &nbsp; &nbsp;
												<input type="checkbox" name="p1b" value="<?php echo $q['p1b']; ?>" />
												<?php echo $q['p1b']; ?>
												
											<br>
												&nbsp;&nbsp; &nbsp; &nbsp;
												&nbsp;&nbsp; &nbsp; &nbsp;
												<input type="checkbox" name="p1c" value="<?php echo $q['p1c']; ?>" />
												<?php echo $q['p1c']; ?>
												
											<br>
												&nbsp;&nbsp; &nbsp; &nbsp;
												&nbsp;&nbsp; &nbsp; &nbsp;
												<input type="checkbox" name="p1d" value="<?php echo $q['p1d']; ?>" />
												<?php echo $q['p1d']; ?>
												
											<br>
												&nbsp;&nbsp; &nbsp; &nbsp;
												&nbsp;&nbsp; &nbsp; &nbsp;
												<input type="checkbox" name="p1e" value="<?php echo $q['p1e']; ?>" />
												<?php echo $q['p1e']; ?>
												
											<br>
												&nbsp;&nbsp; &nbsp; &nbsp;
												&nbsp;&nbsp; &nbsp; &nbsp;
												<input type="checkbox" name="p1nsnr" value="NsNr" />
												<?php echo $q['p1f']; ?>
