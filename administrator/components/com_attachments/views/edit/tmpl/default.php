...
<table class="admintable">
  <tr><td class="key"><?php echo JText::_('PUBLISHED_COLON'); ?></td>
	  <td colspan="4"><?php echo $this->lists['published']; ?></td>
  </tr>
  <tr>
<?php if ( $this->change_parent ): ?>
	  <td class="key"><label for="parent_id"><b><?php
		  echo $this->selpar_label ?></b></label></td>
	  <td colspan="4"><input id="parent_title" value="<?php echo $this->selpar_parent_title; ?>"
...
<?php else: ?>
	  <td class="key"><?php echo
	   ...
	   <td colspan="2"><?php if ( $attachment->parent_id == null ) {
	  ...
	  <a class="changeButton" href="<?php echo $this->change_parent_url; ?>"
	     ...
	     ><?php echo JString::str_ireplace(' ', '&nbsp;', JText::sprintf('CHANGE_ENTITY_S', $attachment->parent_entity_name)); ?></a>
      </td>
	  <td class="switchParent">
...
<?php
	...
	foreach ($this->entity_info as $einfo) {
		...
		$cename = JString::str_ireplace(' ', '&nbsp;', $einfo['name']);
		if ( ($parent_type != $attachment->parent_type) OR
			 ($centity != $attachment->parent_entity) ) {
...
<?php endif; ?>
  ...
  <td colspan="4"><?php echo JText::_(JString::strtoupper($uri_type));?>
...
<?php if ( $update == 'file' ): ?>
  <tr>
	  ...
	  <td colspan="4"><b><?php echo JText::_('SELECT_NEW_FILE_IF_YOU_WANT_TO_UPDATE_ATTACHMENT_FILE') ?></b><br />
...
<?php else: ?>
   ...
   <tr>
	  ...
	  <td colspan="4"><?php echo $attachment->filename; ?>
	  <a class="changeButton" href="<?php echo $this->change_file_url ?>"
  ...
  <tr><td class="key"><?php echo JText::_('SYSTEM_FILENAME'); ?></td>
	  <td colspan="4"><?php echo $attachment->filename_sys; ?></td>
  </tr>
  <tr><td class="key"><?php echo JText::_('URL_COLON'); ?></td>
	  <td colspan="4"><?php echo $attachment->url; ?></td>
  </tr>
...
<?php if ( $update == 'file' OR $uri_type == 'file' ): ?>
  ...
  <tr><td class="key"><label for="display_name"
	  ...
	  <td colspan="4"><input class="text" type="text" name="display_name"
...
<?php endif; ?>
  ...
  <tr><td class="key"><label for="description"
	  ...
	  <td colspan="4"><input class="text" type="text" name="description"
  ...
  <tr><td class="key"><label for="user_field_1"><?php echo $params->get('user_field_1_name'); ?>:</label></td>
	  <td colspan="4"><input class="text" type="text" name="user_field_1"
  ...
  <tr><td class="key"><label for="user_field_2"><?php echo $params->get('user_field_2_name'); ?>:</label></td>
	  <td colspan="4"><input class="text" type="text" name="user_field_2"
  ...
  <tr><td class="key"><label for="user_field_3"><?php echo $params->get('user_field_3_name'); ?>:</label></td>
	  <td colspan="4"><input class="text" type="text" name="user_field_3"
  ...
  <tr><td class="key"><label for="icon_filename"><?php echo JText::_('ICON_FILENAME_COLON'); ?></label></td>
	  <td colspan="2"><?php echo $this->lists['icon_filenames']; ?></td>
  ...
  <tr><td class="key"><?php echo JText::_('DATE_CREATED'); ?>:</td>
	<td colspan="2"><?php echo $create_date; ?></td>
  ...
  <tr><td class="key"><?php echo JText::_('DATE_LAST_UPDATED'); ?>:</td>
	<td colspan="2"><?php echo $modification_date; ?></td>
  ...
  <tr>
	  ...
	  <td <?php if ( !$secure ) { echo "colspan=\"4\""; } else {echo "colspan=\"2\"";} ?>><?php echo $attachment->id; ?></td>
<?php if ( $secure ):
